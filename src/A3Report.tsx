...
interface A3ReportProps {
  setCurrentPage: (page: 'home' | 'a3') => void;
}

const A3Report: React.FC<A3ReportProps> = ({ setCurrentPage }) => {
  return (
    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      <header className="text-center">
        ...
        <h1 className="mt-6 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
          A3 • Concrete Architecture
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-white/70">
          This page presents the A3 report for our CISC 322 project.
        </p>
      ...
      <section className="mt-16 max-w-3xl mx-auto text-white/70 space-y-4">
        <h2 className="text-2xl font-semibold">A3 Report PDF</h2>
        <iframe
          src="/src/assets/A3Report.pdf"
          width="100%"
          height="600"
      ...
      <section className="mt-16 max-w-3xl mx-auto text-white/70 space-y-4">
        <h2 className="text-2xl font-semibold">A3 Slides PDF</h2>
        <iframe
          src="/src/assets/A3ReportSlides.pdf"
          width="100%"
          height="600"
          className="border border-white/10 rounded-lg"
          title="A1 PDF"
