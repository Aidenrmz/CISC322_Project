...
interface A1ReportProps {
  setCurrentPage: (page: 'home' | 'a1') => void;
}

const A1Report: React.FC<A1ReportProps> = ({ setCurrentPage }) => {
  return (
    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      <header className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-white/70">
          This page presents the A1 report for our CISC 322 project.
        </p>
      ...
      <section className="mt-16 max-w-3xl mx-auto text-white/70 space-y-4">
        <h2 className="text-2xl font-semibold">A1 Slides PDF</h2>
        <iframe
